...
try {
  ...
  await page.screenshot({ path: '../verification/branch-gate-desktop.png' });
  await page.setViewportSize({ width: 390, height: 844 });
  await page.screenshot({ path: '../verification/branch-gate-mobile.png' });
  ...
  await fs.writeFile(
    '../verification/branch-workspace-gate.json',
