...
function SelectTrigger({
  ...
  // Keep the disclosure decorative; the trigger itself supplies the accessible name and state.
  return (
...
/** Anchor menus below their controls so opening a picker leaves the surrounding form steady. */
