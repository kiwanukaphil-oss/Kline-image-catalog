...
Current runtime: 0.18.0, released 8 September 2026 as POS `4ad4cae` and Catalog
`c2e33cc`. Merchandise lists return unit totals over the complete filtered result;
delivery cards and pricing counters also show units. No migration was required.
See `verification/unit-totals.json` for the release checks.
