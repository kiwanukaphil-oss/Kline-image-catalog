...
Production: workspace 0.16.0 and all 108 POS migrations are deployed. See [production cutover](production-cutover-plan.md) for backups, exact releases, preservation checks and remaining acceptance.
